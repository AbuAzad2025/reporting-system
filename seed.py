...
with app.app_context():
    ...
    if OPS.DailySiteReport.query.count() == 0:
        add_if_missing(OPS.DailySiteReport, "DSR", project_id=proj.id,
                       ...
                       labor_table=[{"trade": "حدادة", "count": 10},
                                     {"trade": "أعمال خرسانة", "count": 12},
                                     {"trade": "نجارة", "count": 6}],
                       equipment_table=[{"eq_type": "رافعة برجية", "qty": 1,
                                         "hours": 8, "status": "operating"},
                                        {"eq_type": "خلاطة", "qty": 2,
                                         "hours": 6, "status": "operating"},
                                        {"eq_type": "هزاز", "qty": 3,
                                         "hours": 4, "status": "maintenance"}],
                       work_fronts=[{"area": "الدور الثالث",
                                     "activity": "صب أعمدة محاور C-D",
                                     "progress_pct": 40},
                                    {"area": "المحور E",
                                     "activity": "استلام حديد بلاطة",
                                     "progress_pct": 15}])
        add_if_missing(OPS.DailySiteReport, "DSR", author=eng2,
                       ...
                       labor_table=[{"trade": "أعمال حفر", "count": 12},
                                     {"trade": "عمليات نقل", "count": 4}],
                       equipment_table=[{"eq_type": "حفارة", "qty": 1,
                                         "hours": 8, "status": "operating"},
                                        {"eq_type": "مدحلة", "qty": 1,
                                         "hours": 5, "status": "operating"},
                                        {"eq_type": "شاحنات", "qty": 3,
                                         "hours": 6, "status": "operating"}],
                       work_fronts=[{"area": "القطاع الشمالي",
                                     "activity": "أعمال الحفر",
                                     "progress_pct": 30}])
